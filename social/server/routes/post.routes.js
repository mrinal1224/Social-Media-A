...
import { uploadPost, getAllPosts, like, comment, editComment, deleteComment } from '../controllers/post.controllers.js'
...
postRouter.put('/comment/:postId/:commentId', isAuth, editComment);
