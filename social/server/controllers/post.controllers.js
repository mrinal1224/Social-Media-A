...
export const comment = async (req, res) => {
  ...
  try {
    ...
    // populate comment user info and author for client convenience
...
export const deleteComment = async (req, res) => {
  ...
  try {
    ...
    const isCommentOwner = comment.user.toString() === req.userId.toString();
    ...
    return res
      ...
      .json({ message: `Cannot delete comment: ${error.message}` });
